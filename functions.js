...
$(document).ready(function () {
    ...
    //limpa as configrações dos inputs
    ResetConfig();

    //altera a borda esquerda do topo e seu respectivo texto
    ...
    //altera a borda direita do topo e seu respectivo texto
    ...
    //altera a borda esquerda de baixo e seu respectivo texto
    ...
    //altera a borda direita de baixo e seu respectivo texto
...
function ResetConfig(){
    ...
    //define o valor de todos os input = 10
    for(var i = 0; i < 4 ; i++){
